...
@Injectable()
export class LeaveDtoServiceModuleServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAll(): Observable<LeaveDto[]> {
        let url_ = this.baseUrl + "/api/services/app/LeaveDtoServiceModule/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<LeaveDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LeaveDto[]>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<LeaveDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getById(id: number | undefined): Observable<LeaveDto> {
        let url_ = this.baseUrl + "/api/services/app/LeaveDtoServiceModule/GetById?";
        if (id === null)
    ...
    protected processGetById(response: HttpResponseBase): Observable<LeaveDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    create(body: CreateleaveDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LeaveDtoServiceModule/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    update(body: UpdateleaveDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LeaveDtoServiceModule/Update";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    updateStatus(body: UpdateLeaveStatusDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LeaveDtoServiceModule/UpdateStatus";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LeaveDtoServiceModule/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
...
export class UpdateLeaveStatusDto implements IUpdateLeaveStatusDto {
    id: number;
    status: StatusEnum;

    constructor(data?: IUpdateLeaveStatusDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateLeaveStatusDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateLeaveStatusDto();
        result.init(data);
        return result;
    }
...
export interface IUpdateLeaveStatusDto {
    id: number;
    status: StatusEnum;
}

export class UpdateleaveDto implements IUpdateleaveDto {
    id: number;
    employeeName: string;
    leaveType: LeavetypeEnum;
    startDate: moment.Moment;
    ...
    constructor(data?: IUpdateleaveDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateleaveDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateleaveDto();
        result.init(data);
        return result;
    }
...
export interface IUpdateleaveDto {
    id: number;
    employeeName: string;
    leaveType: LeavetypeEnum;
    startDate: moment.Moment;
